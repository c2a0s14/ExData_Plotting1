# plot1.R
# Constructs plot1 and saves it to a PNG file with a width of 480 pixels and a height of 480 pixels.
...
# Make the chart
#---------------------------------------------------
png("plot1.png", width=480, height=480, units="px")     # Launch 

hist(psub$Global_active_power, 
     main="Global Active Power", 
     xlab="Global Active Power (kilowatts)",
     col="red")

dev.off(which=dev.cur())                                # Release       
